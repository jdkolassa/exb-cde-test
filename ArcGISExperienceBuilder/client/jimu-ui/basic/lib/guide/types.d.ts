...
import { type Step as JoyRideStep, type Placement, type Locale, type status as JoyrideStatus, EVENTS } from 'react-joyride';
export type StepType = 'splash' | 'step';
export interface Status extends JoyrideStatus {
    INJECTED: 'injected';
}
export declare const STATUS: Status;
export type StatusValue = Status[keyof Status];
