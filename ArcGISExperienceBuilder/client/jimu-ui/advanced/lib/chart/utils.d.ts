...
import { type WebMapWebChart, type CalculatedMinMaxBoundsPayload, type LegendItemVisibility, type WebChartDataTypes } from '@arcgis/charts-spec';
import { type ActionModes, type SelectionData, type ValidationStatus, type ChartTypes } from '@arcgis/charts-shared-utils';
import { type NotifyOptions } from '@arcgis/charts-js';
