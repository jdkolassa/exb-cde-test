...
import { type ButtonSize, type ImageParam } from 'jimu-ui';
/**
 ...
 */
export declare const ImageSelector: import("@emotion/styled").StyledComponent<Omit<ImageSelectorProps, "intl"> & {
