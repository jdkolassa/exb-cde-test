import { type IMThemeVariables, type IconResult, type IMState, LinkType, type LinkTo, type IMDialogJson } from 'jimu-core';
import { type ColorResult, type RGBColor } from 'jimu-ui/basic/color-picker';
