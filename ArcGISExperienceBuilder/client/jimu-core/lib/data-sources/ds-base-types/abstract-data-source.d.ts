import { type DataSourceManager, type IMDataSourceJson, type IMDataSourceSchema, type IMReversedDataSourceSchema, type IMDataSourceInfo, type ImmutableArray } from 'jimu-core';
import { type GeometryType } from '@esri/arcgis-rest-types';
import { type DataSource, type DataSourceConstructorOptions, type DataRecord, DataSourceStatus } from '../data-source-interface';
/**
