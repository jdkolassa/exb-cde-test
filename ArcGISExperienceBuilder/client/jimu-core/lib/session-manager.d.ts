...
import type { ICredential, IUser } from '@esri/arcgis-rest-auth';
...
interface SessionPermissionInfo {
    url: string;
 ...
 */
export type SessionChangeListener = (sessions: UserSession[], reasonType: SessionChangedReasonType) => void;
/**
...
export declare class SessionManager {
    ...
    private noPermissionSessionList;
    /**
     * Return main session.
     *
     ...
     *        2: else inint session from local storage.
     ...
     */
    signIn(fromUrl?: string, popup?: boolean, desUrl?: string, clientId?: string, forceLogin?: boolean, federatedServcieUrl?: string): Promise<UserSession>;
    /**
     * Start non-OAuth sign in flow and return the user session.
     *
     * @param desUrl The url you want to sign in
     */
    nonOAuthSignIn(desUrl: any): Promise<any>;
    /**
     ...
     * @ignore
     */
    addToNoPermissionSessionList(url: string, isCanceld?: boolean, isIgnored?: boolean, owningSystemUrl?: string): void;
    /**
     * Remove a permission info from no-permission list by url.
     *
     * Note: All federated service items will be removed if remove a portal item
     *
     * @param url service or portal url
     * @ignore
     */
    removeFromNoPermissionSessionList(url: string): void;
    /**
     * Ignore a permission info from no-permission list by url.
     *
     * Note: All federated service items will be ignored if ignore a portal item
     *
     * @param url service or portal url, ignore all items if there in no url paramter
     * @ignore
     */
    ignoreFromNoPermissionSessionList(url?: string): void;
    /**
     * Get a permission info from no-permission list by url.
     * @ignore
     */
    getFromNoPermissionSessionList(url: string): SessionPermissionInfo;
    /**
     * Get permission banner list.
     * @ignore
     */
    getPermissionBannerList(): string[];
    /**
     ...
     * @ignore
     */
    checkSessionPermissionForUrl(url: string, token: string, owningSystemUrl?: string): void;
}
/** @ignore */
