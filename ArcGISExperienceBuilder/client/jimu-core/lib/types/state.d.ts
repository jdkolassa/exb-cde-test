...
import { type UrlParameters } from './url-parameters';
import { type DataSourceStatus, type QueryParams } from '../data-sources/data-source-interface';
...
export interface RuntimeInfo {
    ...
    /** The controller widget id that this widget belongs to, if this widget need to be opened in the floating panel */
