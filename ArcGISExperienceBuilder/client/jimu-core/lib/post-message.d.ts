...
export type PostMessage = PageChangedPostMessage | QueryChangedPostMessage;
 ...
 */
export declare function listenForMessage(type: ListenMessageType, callback: (message: ListenMessage) => void): (evt: MessageEvent<any>) => void;
/**
