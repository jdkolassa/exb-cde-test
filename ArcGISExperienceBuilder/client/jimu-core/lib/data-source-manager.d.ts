import { type DataSource, type DataSourceConstructorOptions } from './data-sources/data-source-interface';
...
export declare class DataSourceManager {
    ...
    isDataSourceUsed(dsId: string): boolean;
    private isDataSourceUsedByWidgets;
    private isDataSourceUsedByMessages;
    private isDataSourceUsedByDataSources;
    private isDataSourceUsedByUseDataSource;
    /**
     * @ignore
