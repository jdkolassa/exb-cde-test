...
import { DataSourceStatus, type QueryParams } from './data-sources/data-source-interface';
...
import { type BaseExtension, type ExtensionPoints } from './extension-spec/extension-spec';
export declare enum ActionKeys {
    ...
    UpdatePermissionBannerList = "UPDATE_PERMISSION_BANNER_LIST",
...
export interface ResetWidgetStateAction {
    type: ActionKeys.ResetWidgetState;
    widgetId: string;
}
export interface ResetWidgetsStateAction {
...
export interface UpdatePermissionBannerListAction {
    type: ActionKeys.UpdatePermissionBannerList;
    permissionBannerList: string[];
}
...
export interface UtilityStateChangeAction {
...
export declare function openWidget(widgetId: string, controllerWidgetId?: string): OpenWidgetAction;
export declare function openWidgets(widgetIds: string[], controllerWidgetId?: string): OpenWidgetsAction;
...
export declare function updatePermissionBannerList(permissionBannerList: string[]): UpdatePermissionBannerListAction;
...
export declare function utilityStateChange(id: string, valid: boolean): UtilityStateChangeAction;
