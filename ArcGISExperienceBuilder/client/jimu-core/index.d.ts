...
declare const lodash: {
    ...
    merge: {
        <TObject_19, TSource_1>(object: TObject_19, source: TSource_1): TObject_19 & TSource_1;
        <TObject_20, TSource1_3, TSource2_3>(object: TObject_20, source1: TSource1_3, source2: TSource2_3): TObject_20 & TSource1_3 & TSource2_3;
        <TObject_21, TSource1_4, TSource2_4, TSource3_2>(object: TObject_21, source1: TSource1_4, source2: TSource2_4, source3: TSource3_2): TObject_21 & TSource1_4 & TSource2_4 & TSource3_2;
        <TObject_22, TSource1_5, TSource2_5, TSource3_3, TSource4_1>(object: TObject_22, source1: TSource1_5, source2: TSource2_5, source3: TSource3_3, source4: TSource4_1): TObject_22 & TSource1_5 & TSource2_5 & TSource3_3 & TSource4_1;
        (object: any, ...otherArgs: any[]): any;
    };
};
declare const esri: {
...
export { AppRoot, React, ReactDOM, ReactDOMClient, ExtensionManager, BaseWidget, WidgetManager, ConfigManager, DataSourceManager, UtilityManager, urlUtils, SessionManager, SessionChangedReasonType, SignInErrorCode, appActions, extensionSpec, utils, appConfigUtils, ReactRedux, MessageManager, Immutable, classNames, uuidv1, hooks, queryString, moduleLoader, jimuHistory, portalUrlUtils, portalUtils, i18n, defaultMessages, DataSourceComponent, MultipleDataSourceComponent, IntlProvider, injectIntl, xss, polished, MutableStoreManager, Keyboard, keyMap, AppKeyboardComponent, keyboardUtils, requestUtils, expressionUtils, dateUtils, createIntl, createIntlCache, useIntl, FormattedDate, FormattedMessage, FormattedNumber, FormattedPlural, FormattedRelativeTime, FormattedTime, esri, lodash, RepeatedDataSourceProvider, withRepeatedDataSource, dataSourceUtils, sharedThemeUtils, utilityUtils, proxyUtils, geometryUtils, ExportJson, ExportCSV, ExportGeoJSON, SetFilter, DataActionManager, invariant, CONSTANTS, ReactResizeDetector, GuideManager, semver, ExpressionResolverComponent, ExpressionResolverErrorCode, _ExpressionResolverComponent, ServiceManager, version, privilegeUtils, spring, saveAs, cancelablePromise };
export type { ResignInFlagsWhen403Error, SignInError, ImmutableObject, ImmutableArray, DataSourceComponentProps, QueryRequiredInfo, MultipleDataSourceComponentProps, IntlShape, RepeatedDataSource, MultipleExpressionResolveResults, SingleExpressionResolveResult, ExpressionResolverComponentProps, I18nMessages };
