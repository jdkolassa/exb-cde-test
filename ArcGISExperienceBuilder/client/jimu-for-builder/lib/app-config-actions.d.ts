import { type IMAppConfig, type IMAttributesJson, type IMCustomThemeJson, type IMDataSourceJson, type IMDialogJson, type IMLayoutJson, type IMMessageJson, type IMPageJson, type IMViewJson, type IMSectionJson, type IMWidgetJson, type LayoutInfo, LayoutItemType, LayoutType, type IMSizeModeLayoutJson, BrowserSizeMode, type Size, type DataSourceJson, type WidgetJson, type IMProxyJson, type IMScreenGroupJson, type IMScreenJson, type UseDataSource, type IMUseDataSource, type IMUtilitiesJson, type UtilityJson, LayoutParentType, type ControllerPanelJson } from 'jimu-core';
...
export declare class AppConfigAction {
   ...
   */
    ...
    addNewWidgetToLayout(targetLayoutId: string, widgetJson: Partial<WidgetJson>): Promise<string>;
    /**
    ...
    editLayoutItemProperty(layoutInfo: LayoutInfo, prop: string, val: any): this;
    ...
    adjustOrderOfItem(layoutInfo: LayoutInfo, insertIndex: number): this;
    ...
    applyDialogTemplate(dialogId: string, templateJson: Template): Promise<void>;
