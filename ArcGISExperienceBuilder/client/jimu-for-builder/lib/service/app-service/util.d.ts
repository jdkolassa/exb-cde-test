...
import { type ICreateItemResponse } from '@esri/arcgis-rest-portal';
import { type AppInfo, SearchType } from '../type';
...
export declare function duplicateResourcesInApp(newAppId: any, originalAppInfo: AppInfo, isCreateNew?: boolean, updateAppConfigVersion?: boolean): Promise<any>;
export declare function duplicateResourcesForCreateNew(newAppId: any, originalAppInfo: AppInfo): Promise<boolean>;
export declare function duplicateResourcesForDuplicate(newAppId: any, originalAppInfo: AppInfo, updateAppConfigVersion?: boolean): Promise<boolean>;
...
export declare function uploadResource(newAppId: any, originalAppInfo: AppInfo, resourceInfo: any, updateAppConfigVersion?: boolean): Promise<boolean>;
