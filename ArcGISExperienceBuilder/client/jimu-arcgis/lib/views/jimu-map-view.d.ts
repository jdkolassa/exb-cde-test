import { JimuMapViewStatus, type DataSource, type DataRecordSet, type ArcGISSubLayer, WidgetState } from 'jimu-core';
...
import { type SelectionMode } from './layers/jimu-feature-layer-scene-layer-view-common';
...
export declare class JimuMapView {
     ...
     * @param parentJimuLayerId layer's parent JimuLayerView id
     ...
     * */
    selectFeaturesByGraphic(graphic: __esri.Graphic, spatialRelationship: string, selectionMode: SelectionMode): Promise<any>;
    /**
     * @ignore
     */
    ...
    /**
     * Indicate JimuMapView is destroyed or not. Returns true if view is not created or view is destroyed, otherwise returns false.
     */
    isDestroyed(): boolean;
    /**
