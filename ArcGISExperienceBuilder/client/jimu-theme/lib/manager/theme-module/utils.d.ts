import { type ImmutableObject, type IMThemeVariables, type ThemeVariables } from 'jimu-core';
 ...
 * @param uri
 */
export declare const getThemeStyle: (name: string, uri?: string) => import("./type").ComponentRootStyle;
/**
 * Get the override style function of the specific component for theme2.
 * @param name
 * @param uri
 */
export declare const getTheme2Style: (name: string) => import("./type").ComponentRootStyle;
/**
